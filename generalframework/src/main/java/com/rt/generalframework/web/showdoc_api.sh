...
# 
api_key="cfecb8769b16ec6bad6c35130312c5061244388628" 			#api_key
api_token="ae4e1c0c62f3a8bc6660f080c71aafd91988022717" 	#api_token
url="http://www.showdoc.cc/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
